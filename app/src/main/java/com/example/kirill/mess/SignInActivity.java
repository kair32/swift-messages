        ...
        mFirebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Log.d(TAG, "signInWithCredential:onComplete:" + task.isSuccessful() + " " +  task.getResult().getUser().getDisplayName());
                        if (!task.isSuccessful()) {
                            Log.w(TAG, "signInWithCredential", task.getException());
                            Toast.makeText(SignInActivity.this, "Authentication failed.", LENGTH_SHORT).show();
                        } else {
                            ...
                            editor.putString("Photo", String.valueOf(task.getResult().getUser().getPhotoUrl()));
                            editor.putString("Email", String.valueOf(task.getResult().getUser().getEmail()));
                            editor.commit();
